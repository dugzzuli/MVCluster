...
if __name__=='__main__':
    ...
    beta_W=10
    random.seed(9001)
    dataset_config = {'View': ['./Database/'+dataset_name+'/View1.txt','./Database/'+dataset_name+'/View2.txt'],
    ...
    with open('./result/'+dataset_name+'.txt',"w") as f:
        ...
        for ccsistent_loss in [0.001,0.01,0.1,0,1,10,50,100,200]:
            ...
            result_single ='ccsistent_loss={:.4f}:'.format(ccsistent_loss)+' acc={:.4f}'.format(acc) + ' & ' + 'nmi={:.4f}'.format(nmi)
